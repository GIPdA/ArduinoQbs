...
ArduinoCore {
    ...
    Properties {
        condition: boardName === "pro5V" // Arduino Pro or Pro Mini 5V, 16MHz, ATmega328p
        //cpu: "atmega328p"
    ...
    Properties {
        condition: boardName === "pro3V3" // Arduino Pro or Pro Mini 3.3V, 16MHz, ATmega328p
        //cpu: "atmega328p"

        property stringList flags_cpu: ["-mmcu=atmega328p"]
        property stringList flags_defines: ["AVR_PRO", "ARDUINO_AVR_PRO", "ARDUINO_ARCH_AVR"] // TODO: check defines
